...
const project: EthereumProject = {
  ...
  description: 'OpenZeppelin Access Control and Ownable indexer for Avalanche C-Chain',
  runner: {
    node: {
  ...
  network: {
    chainId: '43114',
    endpoint: [process.env.AVALANCHE_MAINNET_RPC_URL || 'https://api.avax.network/ext/bc/C/rpc'],
  },
  dataSources: [
