...
/**
 * OP Mainnet Project Configuration
 * Chain ID: 10
 */
import { OPTIMISM_MAINNET } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock =
  Number(process.env.START_BLOCK) || OPTIMISM_MAINNET.startBlock;

const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-optimism-mainnet",
  description: "OpenZeppelin Access Control and Ownable indexer for OP Mainnet",
  runner: {
    node: {
