...
/**
 * Scroll Sepolia Project Configuration
 * Chain ID: 534351
 */
import { SCROLL_SEPOLIA } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock = Number(process.env.START_BLOCK) || SCROLL_SEPOLIA.startBlock;

const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-scroll-sepolia",
  description:
    "OpenZeppelin Access Control and Ownable indexer for Scroll Sepolia",
  runner: {
    node: {
