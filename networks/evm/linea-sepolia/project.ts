 ...
 * Chain ID: 59141
 */
import { LINEA_SEPOLIA } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock = Number(process.env.START_BLOCK) || LINEA_SEPOLIA.startBlock;
...
const project: EthereumProject = {
  ...
  description:
    "OpenZeppelin Access Control and Ownable indexer for Linea Sepolia",
  runner: {
    node: {
