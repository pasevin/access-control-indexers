...
const project: EthereumProject = {
  ...
  description: 'OpenZeppelin Access Control and Ownable indexer for Polkadot Hub TestNet',
  runner: {
    node: {
  ...
  network: {
    chainId: '420420417',
    endpoint: [process.env.POLKADOT_HUB_TESTNET_RPC_URL || 'https://services.polkadothub-rpc.com/testnet'],
  },
  dataSources: [
