...
/**
 * Polkadot Hub TestNet Project Configuration
 * Chain ID: 420420417
 */
import { POLKADOT_HUB_TESTNET } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock =
  Number(process.env.START_BLOCK) || POLKADOT_HUB_TESTNET.startBlock;

const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-polkadot-hub-testnet",
  description:
    "OpenZeppelin Access Control and Ownable indexer for Polkadot Hub TestNet",
  runner: {
    node: {
