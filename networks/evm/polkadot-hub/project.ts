 ...
 * Chain ID: 420420419
 */
import { POLKADOT_HUB } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock = Number(process.env.START_BLOCK) || POLKADOT_HUB.startBlock;
...
const project: EthereumProject = {
  ...
  description:
    "OpenZeppelin Access Control and Ownable indexer for Polkadot Hub",
  runner: {
    node: {
