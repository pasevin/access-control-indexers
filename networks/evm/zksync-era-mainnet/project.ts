...
const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-zksync-era-mainnet",
  description: "OpenZeppelin Access Control and Ownable indexer for ZkSync Era",
  runner: {
    node: {
  ...
  network: {
    chainId: "324",
    endpoint: [
      process.env.ZKSYNC_ERA_MAINNET_RPC_URL || "https://mainnet.era.zksync.io",
    ],
  },
  dataSources: [
