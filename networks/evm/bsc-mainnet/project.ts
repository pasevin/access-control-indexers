...
const project: EthereumProject = {
  specVersion: '1.0.0',
  version: '1.0.0',
  name: 'oz-access-control-bsc-mainnet',
  description: 'OpenZeppelin Access Control and Ownable indexer for BNB Smart Chain',
  runner: {
    node: {
  ...
  network: {
    chainId: '56',
    endpoint: [process.env.BSC_MAINNET_RPC_URL || 'https://bsc-dataseed.binance.org'],
  },
  dataSources: [
