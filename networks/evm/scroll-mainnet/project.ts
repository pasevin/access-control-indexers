...
/**
 * Scroll Project Configuration
 * Chain ID: 534352
 */
import { SCROLL_MAINNET } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock = Number(process.env.START_BLOCK) || SCROLL_MAINNET.startBlock;

const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-scroll-mainnet",
  description: "OpenZeppelin Access Control and Ownable indexer for Scroll",
  runner: {
    node: {
