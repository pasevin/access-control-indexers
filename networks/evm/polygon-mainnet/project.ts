...
const project: EthereumProject = {
  specVersion: '1.0.0',
  version: '1.0.0',
  name: 'oz-access-control-polygon-mainnet',
  description: 'OpenZeppelin Access Control and Ownable indexer for Polygon',
  runner: {
    node: {
  ...
  network: {
    chainId: '137',
    endpoint: [process.env.POLYGON_MAINNET_RPC_URL || 'https://polygon-rpc.com'],
  },
  dataSources: [
