...
/**
 * Linea Project Configuration
 * Chain ID: 59144
 */
import { LINEA_MAINNET } from "@oz-indexers/network-config";

// Start block can be overridden via START_BLOCK env var (e.g., for staging deployments)
const startBlock = Number(process.env.START_BLOCK) || LINEA_MAINNET.startBlock;

const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-linea-mainnet",
  description: "OpenZeppelin Access Control and Ownable indexer for Linea",
  runner: {
    node: {
