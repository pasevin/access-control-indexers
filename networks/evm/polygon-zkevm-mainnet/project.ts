...
const project: EthereumProject = {
  specVersion: "1.0.0",
  version: "1.0.0",
  name: "oz-access-control-polygon-zkevm-mainnet",
  description:
    "OpenZeppelin Access Control and Ownable indexer for Polygon zkEVM",
  runner: {
    node: {
  ...
  network: {
    chainId: "1101",
    endpoint: [
      process.env.POLYGON_ZKEVM_MAINNET_RPC_URL || "https://zkevm-rpc.com",
    ],
  },
  dataSources: [
