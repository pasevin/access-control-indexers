...
const project: EthereumProject = {
  ...
  description: 'OpenZeppelin Access Control and Ownable indexer for Polygon zkEVM Cardona',
  runner: {
    node: {
  ...
  network: {
    chainId: '2442',
    endpoint: [process.env.POLYGON_ZKEVM_CARDONA_RPC_URL || 'https://rpc.cardona.zkevm-rpc.com'],
  },
  dataSources: [
